        ...
        <div className="editorial-container">
          <div className="contact-grid">
            <div className="contact-info-panel text-center">
              ...
              <p className="highlight-text-small" style={{ maxWidth: '600px', margin: '0 auto 2rem' }}>
                Estamos aquí para ayudarte a encontrar el espacio perfecto para tu próximo evento corporativo.
              </p>
              
              <div className="contact-details-large" style={{ alignItems: 'center' }}>
              ...
              <div className="quote-box" style={{ marginTop: '4rem', padding: '3rem', background: 'var(--muted)', width: '100%', borderLeft: 'none', borderTop: '4px solid var(--primary)' }}>
                <p style={{ fontStyle: 'italic', color: 'var(--primary)', fontSize: '1.4rem', fontFamily: 'var(--font-serif)', maxWidth: '700px', margin: '0 auto' }}>
            ...
            <div className="contact-form-wrapper w-full" style={{ maxWidth: '600px' }}>
              <div className="contact-actions" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <a 
                ...
                <a 
                  ...
                  style={{ display: 'block', textDecoration: 'none', padding: '2rem' }}
                >
                  RELLENAR FORMULARIO DETALLADO
                </a>
                
                <p style={{ fontSize: '1rem', color: 'var(--muted-foreground)', textAlign: 'center', marginTop: '1.5rem', fontStyle: 'italic' }}>
